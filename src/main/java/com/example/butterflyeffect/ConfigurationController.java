...
public class ConfigurationController {
        ...
        public void addBtn(ActionEvent event) {
            tasks.add(new Task(tNameTxt.getText(),Integer.parseInt(tPriorityTxt.getText()),Double.parseDouble(tTimeTakenTxt.getText()), Integer.parseInt(tDueDateTxt.getText()), tDetailsTxt.getText(),isItDifficult, isItEasy));
